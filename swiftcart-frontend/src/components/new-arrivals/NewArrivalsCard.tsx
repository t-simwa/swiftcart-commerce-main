...
export function NewArrivalsCard({ product, className, style }: NewArrivalsCardProps) {
  ...
  const handleBrandClick = (e: React.MouseEvent) => {
    e.preventDefault();
    e.stopPropagation();
    navigate(`/new-arrivals?brands=${encodeURIComponent(brand)}`);
  };
