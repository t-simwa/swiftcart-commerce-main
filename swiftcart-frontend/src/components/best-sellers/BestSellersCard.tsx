...
export function BestSellersCard({ product, className, style }: BestSellersCardProps) {
  ...
  const handleBrandClick = (e: React.MouseEvent) => {
    e.preventDefault();
    e.stopPropagation();
    navigate(`/best-sellers?brands=${encodeURIComponent(brand)}`);
  };
